...
/************************************************************************
 ...
 Una cola circular es un modelo estatico que eficientiza el proceso de 
 desencolar elementos en el espacio con el que cuenta para almacenar los 
 elementos dentro del TAD Cola. 
 Logrando nunca mover de memoria a los elementos una vez que son desencolados 
 y hasta que son desencolados.

 En este archivo se incluyen las definiciones de las operaciones del TAD

 Compilación: gcc -c TADColaDin.c                                  
                                                                       
*************************************************************************/

//LIBRERAS
#include "lib\TADColaEst.h"
#include<stdio.h>
#include<stdlib.h>
